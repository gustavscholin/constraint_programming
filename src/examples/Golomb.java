...
/**
 * 
 * It models a examples.Golomb ruler problem.
 * 
 * @author Radoslaw Szymanek and Krzysztof Kuchcinski
 *
 * 
 * examples.Golomb ruler is a special sequence of natural numbers
 * an example is 0 1 4 6
 *
 * a sequence is a examples.Golomb ruler if all differences are different
 * (1-0), (4-0), (6-0), (4-1), (6-1), (6-4)
 * 1 4 6 3 5 2
 * All differences above have different values
 * A examples.Golomb ruler is optimal if the length of it (the last mark)
...
public class Golomb {
    ...
    /**
     * It executes the program which computes the optimal examples.Golomb ruler.
     * 
	...
	System.out.println("Program to solve examples.Golomb mark problem - length "
			   + noMarks);
	...
	for (int i = 0; i < numbers.length; i++) {
	    ...
	    // examples.Golomb ruler is an ordered sequence of numbers
	    if (i > 0)
